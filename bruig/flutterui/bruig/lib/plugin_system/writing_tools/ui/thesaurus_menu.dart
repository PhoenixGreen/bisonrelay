import 'package:bruig/plugin_system/writing_tools/ui/writing_actions.dart';
          ...
          Expanded(
            child: Text.rich(
                TextSpan(children: [
                  ...
                  // The example on its own line under the definition, in
                  // the voice the writing itself is not: italic and quieter,
                  // so it reads as an illustration rather than as more of
                  // the definition. Quoted because it is a sentence
                  // somebody else wrote, and a sentence sitting unmarked
                  // under a definition reads as part of it.
                  if (definitions[i].example.isNotEmpty)
                    TextSpan(
