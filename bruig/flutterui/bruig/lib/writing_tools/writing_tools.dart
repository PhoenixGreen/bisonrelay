...
import 'package:bruig/writing_tools/ui/writing_settings.dart';
...
// and the post editor's review sidebar. App code outside lib/writing_tools/
...
export 'package:bruig/writing_tools/engine/preferences.dart';
export 'package:bruig/writing_tools/engine/stats.dart';
export 'package:bruig/writing_tools/engine/writing_issue.dart';
export 'package:bruig/writing_tools/spellcheck_capability.dart';
export 'package:bruig/writing_tools/thesaurus_capability.dart';
export 'package:bruig/writing_tools/ui/sidebar/writing_sidebar.dart';
export 'package:bruig/writing_tools/ui/thesaurus_menu.dart';
export 'package:bruig/writing_tools/ui/writing_actions.dart';
export 'package:bruig/writing_tools/ui/writing_field.dart';
export 'package:bruig/writing_tools/ui/writing_popup.dart';
export 'package:bruig/writing_tools/ui/writing_settings.dart';
