...
class MarkdownStyleSheet {
  ...
  /// Bison Relay: the vertical space between the items of a list, when it
  /// should differ from [blockSpacing].
  ///
  /// Upstream has one figure and puts it between every pair of block
  /// children, list items included -- so the space that makes prose read as
  /// paragraphs is also the space between bullets, and a list set with it
  /// falls apart into unrelated lines. Choosing the smaller of the two left
  /// headings, quotations and code blocks jammed against whatever came
  /// before them. Null keeps upstream's single figure.
  ...
  /// Bison Relay: the decoration behind the header row of a table.
  ///
  /// Upstream has tableCellsDecoration for the body rows -- applied to every
  /// other one, which is what makes stripes -- and nothing at all for the
  /// header, which is the row most worth telling apart from the rest.
